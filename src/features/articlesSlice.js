...
const handleResponse = async (res, rejectWithValue) => {
  if (!res.ok) {
...
export const unfavoriteArticle = createAsyncThunk(
  ...
  async ({ apiToken, slug }, { rejectWithValue }) => {
    try {
      ...
      return handleResponse(res, rejectWithValue);
    } catch (err) {
...
export const getArticle = createAsyncThunk(
  'articles/getArticle',
  async ({ slug, apiToken }, { rejectWithValue }) => {
    try {
      const res = await fetch(`${apiBase}/articles/${slug}`, {
        method: 'GET',
        headers: {
...
export const getArticles = createAsyncThunk(
  ...
  async ({ skip, apiToken }, { rejectWithValue }) => {
    try {
...
export const { changeStateReRender, errorClear } = articlesSlice.actions;
